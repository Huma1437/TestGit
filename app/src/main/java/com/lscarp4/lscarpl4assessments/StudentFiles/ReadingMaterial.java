...
public class ReadingMaterial extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ReadingMaterial.this,MainActivity.class);
                startActivity(intent);
            }
        });

        header.setText("Reading Materials");
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ReadingMaterial.this,Login.class);
                startActivity(intent);
            }
        });
        ...
        desc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog = new Dialog(ReadingMaterial.this);
